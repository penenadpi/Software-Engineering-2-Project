...
assert selfMessage{
all m1,m2,m3:Message,u:User | AssignReceiver[m1,m2,u] and AssignSender[m2,m3,u]
}
check selfMessage for 5



assert RegisterUser1{
all u1,u2,u3,u4: User,name:Strings | RegisterUser[u1,u2,name] and RegisterUser [u3,u4,name]
}
check RegisterUser1 for 5


assert RegisterUser2{
all u1,u2,u3,u4: User,name:Strings | RegisterUser[u1,u2,name] and RegisterUser [u3,u4,name] implies (u4=u2)
}
check RegisterUser2 for 5
...
//Simulate sending of the message
pred AssignSender(m1,m2:Message,u:User)
{
m2.sender=m1.sender+u
}
run AssignReceiver for 5
...
//Registrationof the user
pred RegisterUser(u1,u2:User,name:Strings)
{
u2.username=u1.username+name
}
run RegisterUser for 5
